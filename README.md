				...
				Есть две возможности задать правило:
					a) Ввести команду 'commands'.
						...
						Система выводит список возможных команд:
							...
							9. Less            <
							10. LessEqual      <=
						Если в дальнейшем пользователь захочет увидеть снова данный список, он может в любой момент создания правила
						ввести команду 'help' и продолжать дальнейший ввод.
